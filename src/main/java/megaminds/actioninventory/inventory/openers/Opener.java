...
public abstract class Opener extends Typed<Type> {
	public enum Type {
		NAME(NameOpener.class), TAG(TagOpener.class), NBT(NbtOpener.class), POS(PosOpener.class), UUID(UUIDOpener.class), TEAM(TeamOpener.class), IDENTIFIER(IdentifierOpener.class);
