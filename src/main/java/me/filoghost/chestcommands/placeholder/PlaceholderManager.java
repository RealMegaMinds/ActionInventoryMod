...
public class PlaceholderManager {
    ...
    public static String replaceDynamicPlaceholders(String text, ServerPlayerEntity player) {
    ...
    private static @Nullable String getReplacement(PlaceholderMatch placeholderMatch, ServerPlayerEntity player) {
